...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no "if"- é verdade
if (a == 10) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no "else"- é falso
if (a > 10) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no "if"- é verdadeiro
if (b == true) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar como "if"- é verdade 
if (c) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'):  Vai entrar como "else"- é falso
if (d[1] == 1) {
